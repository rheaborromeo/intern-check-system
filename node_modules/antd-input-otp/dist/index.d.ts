...
import { InputProps, InputRef, FormInstance } from 'antd';
...
type TAutoSubmit<T extends 'uncontrolled' | 'controlled'> = T extends 'uncontrolled' ? FormInstance : (value: string[]) => void;
...
type InputOTPProps = StandardInputType | CustomInputType;
